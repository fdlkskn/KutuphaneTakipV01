...
namespace KutuphaneTakipV01.Classlar
{
    public class DBbaglanti
    {
        public static string DBadres = @"Data Source=" + Environment.CurrentDirectory + "\\DB\\kitap.db;versiyon=3;New=False;Compress=True;Read Only=False;";
